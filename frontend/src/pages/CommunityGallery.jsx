      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-10">
        <div>
          <h1 className="text-3xl font-black flex items-center gap-2">
            <Sparkles className="text-[#B0FF00] w-7 h-7" /> COMMUNITY CANVAS
          </h1>
        ...
        <div className="relative max-w-md w-full">
          ...
          <input 
            ...
            className="w-full bg-[#111115]/80 border border-slate-800 rounded-xl py-3 pl-11 pr-4 text-sm text-white focus:border-[#B0FF00] outline-none transition"
          />
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {filteredItems.map(item => (
            <div 
              ...
              className="bg-[#111115]/60 border border-slate-800/80 rounded-2xl overflow-hidden group hover:border-[#B0FF00]/40 transition duration-300 flex flex-col justify-between"
            >
              {/* Image Frame */}
              <div className="relative aspect-square w-full overflow-hidden bg-black/40">
                ...
                {/* Style Badge */}
                <span className="absolute top-3 left-3 bg-[#B0FF00]/95 text-black text-[10px] font-black uppercase px-2.5 py-1 rounded-full shadow-lg">
                  {item.style_applied}
                </span>
